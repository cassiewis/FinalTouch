...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AddProductComponent, AddReservationComponent],
  templateUrl: './backoffice-home.component.html',
  styleUrl: './backoffice-home.component.css'
})
export class BackofficeHomeComponent implements OnInit {
  ...
  constructor(private reservationService: ReservationService, private productService: ProductService){
